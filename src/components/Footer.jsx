function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 flex justify-center items-center mx-auto p-3 text-[14px] w-full z-10 h-[80px]">
      <div className="flex items-center dark:text-alltext-dark text-alltext-light">
        ...
        <div className="ml-2 text-[14px] flex items-center">
